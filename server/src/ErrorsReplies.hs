...
encodeError (Err NoEmptyString _) = addToText "The string you've submitted was empty." mempty
...
encodeError (Err BorkedData _) = addToText "You've tried to participate to an inactive poll." mempty
